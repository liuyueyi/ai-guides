...
- [x] [15.接入OpenAI接口风格大模型](基础篇/15.接入OpenAI接口风格的大模型.md)
- [x] [16.异步流式模型调用](基础篇/16.异步流式模型调用.md)
- [x] [17.推理大模型接入与推理过程返回](基础篇/17.推理大模型接入与推理过程返回.md)
- [x] [18.语音模型之语音识别](基础篇/18.语音模型之语音识别.md)
- [ ] [检索增强生成RAG]()
