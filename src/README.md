...
title: 主页
heroImage: /logo.jpg
heroText: 助力Java开发拥抱大模型时代
tagline: 通过成体系的基础版、进阶版、实战版系列教程，帮你快速掌握大模型应用与Agent开发技术，实现AI时代的职业升级
actions:
  - text: LLM开发手册 💡
    link: /tutorial/
    type: primary
...
<section class="llm-py-16 llm-bg-gradient-blue-purple">
  <div class="llm-container">
      <div class="llm-text-center llm-mb-2">
          <h2 class="llm-text-responsive llm-font-bold" style="margin-top: 0;">这里包含什么？</h2>
          <p class="llm-text-gray-600 llm-mt-2">专为Java开发者打造的大模型应用开发进阶之路</p>
      </div>
      <div class="llm-grid llm-md-grid-cols-3 llm-gap-8">
          <a class="llm-bg-gray-50 llm-p-6 llm-rounded-xl llm-card-hover" style="text-decoration: none;" href="tutorial/">
              <div class="llm-w-12 llm-h-12 bg-primary-div-10 llm-rounded-lg llm-flex llm-items-center llm-justify-center llm-mb-4">
                  <i class="fa fa-code llm-text-primary llm-text-xl"></i>
              </div>
              <h3 class="llm-text-xl llm-font-semibold llm-mb-2">全栈技术体系</h3>
              <p class="llm-text-gray-600">从LLM基础到Agent实战，覆盖SpringAI、LangGraph等核心技术栈</p>
          </a>
          <a class="llm-bg-gray-50 llm-p-6 llm-rounded-xl llm-card-hover" style="text-decoration: none;" href="ai-dev/">
              <div class="llm-w-12 llm-h-12 bg-primary-div-10 llm-rounded-lg llm-flex llm-items-center llm-justify-center llm-mb-4">
                  <i class="fa fa-rocket llm-text-primary llm-text-xl"></i>
              </div>
              <h3 class="llm-text-xl llm-font-semibold llm-mb-2">实战驱动教学</h3>
              <p class="llm-text-gray-600">通过真实项目案例，让你边学边练，快速掌握落地能力</p>
          </a>
          <a class="llm-bg-gray-50 llm-p-6 llm-rounded-xl llm-card-hover" style="text-decoration: none;" href="https://github.com/liuyueyi/spring-ai-demo" target="_blank">
              <div class="llm-w-12 llm-h-12 bg-primary-div-10 llm-rounded-lg llm-flex llm-items-center llm-justify-center llm-mb-4">
      ...
      <div class="llm-mt-8 llm-mb-12 lm-py-16" style="margin-top: 1em;">
          <h3 class="llm-text-2xl llm-font-bold llm-text-center llm-mb-8">实战案例演示</h3>
          <div class="llm-grid llm-md-grid-cols-2 llm-lg-grid-cols-3 llm-gap-8">
              ...
              <a class="llm-case-item "  style="text-decoration: none;" href="https://mp.weixin.qq.com/s/NHqLJbos-_nrxNNmhg7IBQ" target="_blank">
                 <img src="https://ppai.top/ai-guides/imgs/column/springai/D04-3.gif" style="height: 170px;" alt="SpringAI开发RAG问答机器人" title="SpringAI开发RAG问答机器人">
...
<section id="courses" class="llm-py-16 llm-bg-gray-50">
  <div class="llm-container">
      <div class="llm-text-center llm-mb-12">
          <h2 class="llm-text-responsive llm-font-bold">系列教程</h2>
          <p class="llm-text-gray-600 llm-mt-2">从入门到精通，系统掌握大模型应用开发</p>
      </div>
      <div class="llm-grid llm-grid-cols-1 llm-md-grid-cols-2 llm-lg-grid-cols-3 llm-gap-8">
          <div class="llm-bg-white llm-rounded-xl llm-overflow-hidden llm-shadow-md llm-card-hover">
              <div class="llm-h-24 llm-card-gradient">
                  <i class="fa fa-book llm-text-white llm-text-5xl" style="font-size:3rem"></i>
              </div>
              <div class="llm-p-6">
                  <h3 class="llm-text-xl llm-font-semibold llm-mb-2">SpringAI扫盲</h3>
                  <p class="llm-text-gray-600 llm-text-sm llm-mb-4">详解SpringAI实现AI应用开发，LangGraph进行Agent开发需要掌握的基础技能点</p>
                  <a href="ai-dev/基础篇/" class="llm-link-primary">
          ...
          <div class="llm-bg-white llm-rounded-xl llm-overflow-hidden llm-shadow-md llm-card-hover">
              <div class="llm-h-24 llm-card-gradient">
                  <i class="fa fa-code-fork llm-text-white llm-text-5xl" style="font-size:3rem"></i>
              </div>
              <div class="llm-p-6">
                  <h3 class="llm-text-xl llm-font-semibold llm-mb-2">SpringAI进阶</h3>
                  <p class="llm-text-gray-600 llm-text-sm llm-mb-4">不满足SpringAI基础知识点的你，不妨看看这里</p>
                  <a href="ai-dev/进阶篇/" class="llm-link-primary">
                      开始学习 <i class="fa fa-arrow-right llm-ml-1"></i>
                  </a>
              </div>
          </div>
          <div class="llm-bg-white llm-rounded-xl llm-overflow-hidden llm-shadow-md llm-card-hover">
              ...
              <div class="llm-p-6">
                  <h3 class="llm-text-xl llm-font-semibold llm-mb-2">SpringAI应用实战</h3>
                  <p class="llm-text-gray-600 llm-text-sm llm-mb-4">基于SpringAI手把手教你实现一些大模型应用、Agent的开发案例</p>
          ...
          <div class="llm-bg-white llm-rounded-xl llm-overflow-hidden llm-shadow-md llm-card-hover">
              <div class="llm-h-24 llm-card-gradient">
                  <i class="fa fa-lightbulb-o llm-text-white llm-text-5xl" style="font-size:3rem"></i>
              </div>
              <div class="llm-p-6">
                  <h3 class="llm-text-xl llm-font-semibold llm-mb-2">LLM零基础入门</h3>
                  <p class="llm-text-gray-600 llm-text-sm llm-mb-4">大模型零基础入门教程，无编程语言背景限制，适合每一个希望从事LLM开发的小伙伴</p>
                  <a href="tutorial/hello-llm/" class="llm-link-primary">
                      开始学习 <i class="fa fa-arrow-right llm-ml-1"></i>
                  </a>
              </div>
          </div>
          <div class="llm-bg-white llm-rounded-xl llm-overflow-hidden llm-shadow-md llm-card-hover">
              <div class="llm-h-24 llm-card-gradient">
                  <i class="fa fa-terminal llm-text-white llm-text-5xl" style="font-size:3rem"></i>
              </div>
              <div class="llm-p-6">
                  <h3 class="llm-text-xl llm-font-semibold llm-mb-2">AI编程实战</h3>
                  <p class="llm-text-gray-600 llm-text-sm llm-mb-4">氛围编程，手把手教你通过AI编程工具实现你的Idea，当然也少不了一些创收的小技巧</p>
                  <a href="tutorial/ai-coding/" class="llm-link-primary">
                      开始学习 <i class="fa fa-arrow-right llm-ml-1"></i>
                  </a>
              </div>
          </div>
          <div class="llm-bg-white llm-rounded-xl llm-overflow-hidden llm-shadow-md llm-card-hover">
              <div class="llm-h-24 llm-card-gradient">
                  <i class="fa fa-braille llm-text-white llm-text-5xl" style="font-size:3rem"></i>
              </div>
              <div class="llm-p-6">
                  <h3 class="llm-text-xl llm-font-semibold llm-mb-2">Hello Agent</h3>
                  <p class="llm-text-gray-600 llm-text-sm llm-mb-4">Agent是什么？为什么大家都在搞agent？</p>
                  <a href="tutorial/hello-agent/" class="llm-link-primary">
                      开始学习 <i class="fa fa-arrow-right llm-ml-1"></i>
                  </a>
              </div>
          </div>
